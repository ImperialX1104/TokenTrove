    ...
    <section className="relative h-screen">
      <div className="lg:flex lg:h-full">
        ...
        <div className="relative text-center lg:w-1/2">
          <img src="https://deothemes.com/envato/xhibiter/html/img/login.jpg" alt="login" className="absolute h-full w-full object-cover" />
          {/* Logo */}
          <Link to="/" className="relative inline-block py-36">
            <img src="https://deothemes.com/envato/xhibiter/html/img/logo_white.png" className="inline-block max-h-7" alt="Xhibiter | NFT Marketplace" />
          </Link>
        </div>
        {/* Right */}
        <div className="relative flex items-center justify-center p-[10%] lg:w-1/2">
          ...
          <div className="w-full max-w-[25.625rem] text-center">
            ...
            <ul className="nav nav-tabs scrollbar-custom mb-12 flex items-center justify-start overflow-x-auto overflow-y-hidden border-b border-jacarta-100 pb-px dark:border-jacarta-600 md:justify-center" role="tablist">
              ...
              <li className="nav-item" role="presentation">
                <button className="nav-link relative flex items-center whitespace-nowrap py-3 px-6 text-jacarta-400 hover:text-jacarta-700 dark:hover:text-white" id="wallet-connect-tab" data-bs-toggle="tab" data-bs-target="#wallet-connect" type="button" role="tab" aria-controls="wallet-connect" aria-selected="false">
                  <svg width={16} height={16} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="mr-1 mb-[2px] h-4 w-4 fill-current">
            ...
            <div className="tab-content">
              ...
              <div className="tab-pane fade show active" id="ethereum" role="tabpanel" aria-labelledby="ethereum-tab">
                <button className="js-wallet mb-4 flex w-full items-center justify-center rounded-full border-2 border-transparent bg-accent py-4 px-8 text-center font-semibold text-white transition-all hover:bg-accent-dark" data-bs-toggle="modal" data-bs-target="#walletModal">
                  <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/metamask_24.svg" className="mr-2.5 inline-block h-6 w-6" alt />
                ...
                <button className="mb-4 flex w-full items-center justify-center rounded-full border-2 border-jacarta-100 bg-white py-4 px-8 text-center font-semibold text-jacarta-700 transition-all hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:hover:border-transparent dark:hover:bg-accent">
                  <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/torus_24.svg" className="mr-2.5 inline-block h-6 w-6" alt />
                  <span>Torus</span>
                </button>
                <button className="mb-4 flex w-full items-center justify-center rounded-full border-2 border-jacarta-100 bg-white py-4 px-8 text-center font-semibold text-jacarta-700 transition-all hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:hover:border-transparent dark:hover:bg-accent">
                  <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/wallet_connect_24.svg" className="mr-2.5 inline-block h-6 w-6" alt />
              ...
              <div className="tab-pane fade" id="torus" role="tabpanel" aria-labelledby="torus-tab">
                ...
                <button className="js-wallet mb-4 flex w-full items-center justify-center rounded-full border-2 border-jacarta-100 bg-white py-4 px-8 text-center font-semibold text-jacarta-700 transition-all hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:hover:border-transparent dark:hover:bg-accent" data-bs-toggle="modal" data-bs-target="#walletModal">
                  <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/metamask_24.svg" className="mr-2.5 inline-block h-6 w-6" alt />
                  <span>Sign in with Metamask</span>
                </button>
                <button className="mb-4 flex w-full items-center justify-center rounded-full border-2 border-jacarta-100 bg-white py-4 px-8 text-center font-semibold text-jacarta-700 transition-all hover:border-transparent hover:bg-accent hover:text-white dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:hover:border-transparent dark:hover:bg-accent">
