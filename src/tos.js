        ...
        <section className="relative py-16 dark:bg-jacarta-800 md:py-24">
          ...
          <div className="container">
            ...
            <div className="article-content mx-auto max-w-[48.125rem]">
              ...
              <p>
                These Terms of Service (“Terms”) govern your access to and use of the TokenTrove website(s), our APIs,
              ...
              <p>
                TokenTrove is not a wallet provider, exchange, broker, financial institution, or creditor. TokenTrove provides
              ...
              <p>
                ...
                materials contained therein, including, without limitation, the TokenTrove logo and all designs, text,
                graphics, pictures, data, software, sound files, other files, and the selection and arrangement thereof
                are the proprietary property of TokenTrove or our affiliates, licensors, or users, as applicable, and you
              ...
              <h2>Miscellaneous</h2>
              <p>
                These Terms constitute the entire agreement between you and TokenTrove relating to your access to and use of
                the Service. These Terms, and any rights and licenses granted hereunder, may not be transferred or
                assigned by you without the prior written consent of TokenTrove, and TokenTrove’s failure to assert any right
              ...
              <p>
                ...
                local laws. You and TokenTrove agree that the United Nations Convention on Contracts for the International
