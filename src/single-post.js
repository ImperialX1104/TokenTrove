...
function SinglePost() {
    return (
        <div>
            <title>Xhibiter | NFT Marketplace</title>
            <meta charSet="utf-8" />
                ...
                <section className="relative py-16 md:py-24">
                    ...
                    <div className="container">
                        <header className="mx-auto mb-16 max-w-lg text-center">
                            <div className="mb-3 inline-flex flex-wrap items-center space-x-1 text-xs">
                                <span className="inline-flex flex-wrap items-center space-x-1 text-accent">
                                    <Link to="/single-post">NFT's</Link>
                                    <Link to="/single-post">DIGITAL ART</Link>
                                </span>
                            </div>
                            ...
                            <div className="inline-flex items-center">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/blog/author.jpg" alt="author" className="mr-4 h-10 w-10 shrink-0 rounded-full" />
                                <div className="text-left">
                                    <span className="text-2xs font-medium tracking-tight text-jacarta-700 dark:text-jacarta-200">Deothemes</span>
                                    {/* Date / Time */}
                        ...
                        <figure className="mb-16">
                            <img src="https://deothemes.com/envato/xhibiter/html/img/blog/single_post_featured.jpg" alt="post 1" className="w-full rounded-2.5xl" />
                        </figure>
                        {/* Article */}
                        <article className="mb-12">
                            ...
                            <div className="article-content">
                                ...
                                <p>
                                Non-Fungible Tokens (NFTs) have emerged as a groundbreaking innovation that is revolutionizing the digital landscape. These unique digital assets are indivisible, irreplaceable, and represent ownership of a specific item or piece of content. Built on blockchain technology, NFTs provide a secure and transparent system for verifying ownership and provenance.
                                </p>
                                <div className="article-content-wide my-12 grid grid-cols-1 gap-[1.875rem] sm:grid-cols-2">
                                    <img src="https://deothemes.com/envato/xhibiter/html/img/blog/gallery_1.jpg" alt="gallery 1" className="rounded-2lg" />
                                    <img src="https://deothemes.com/envato/xhibiter/html/img/blog/gallery_2.jpg" alt="gallery 2" className="rounded-2lg" />
                                </div>
                                <p>
                                NFTs have sparked a profound impact on various industries, particularly in the realms of art, entertainment, gaming, and collectibles. Artists and creators can tokenize their work, giving rise to a new era of digital art ownership and monetization. Collectors and enthusiasts now have the opportunity to own exclusive virtual assets, ranging from digital art pieces to virtual real estate and beyond.
                                </p>
                                <p>
                                With the meteoric rise of NFT marketplaces and auctions, the value and demand for these digital assets have reached unprecedented levels. However, the NFT space also faces challenges such as environmental concerns related to energy consumption and the need for ensuring copyright protection.
                                </p>
                                <p>
                                As the NFT ecosystem continues to evolve, it reshapes how we perceive digital ownership, copyright, and the future of creative expression. Exploring the potential of NFTs and their impact on our digital world presents both thrilling opportunities and important considerations for the future of creativity and ownership in the digital age.
                                </p>
                                <blockquote className="!my-10 text-xl italic text-jacarta-700 dark:text-white">
                                    “I think the biggest thing for NFTs is that they allow artists to participate in the value creation that happens within the secondary market.”
                                    <cite className="mt-3 block text-2xs not-italic tracking-tight text-jacarta-400">— Gary Vaynerchuk</cite>
                                </blockquote>
                                <p>
                                Non-Fungible Tokens (NFTs) have emerged as a revolutionary concept in the digital world. NFTs represent unique digital assets, each with its distinct value and ownership, making them one-of-a-kind. These tokens are built on blockchain technology, ensuring transparency and security in ownership. With NFTs, artists, creators, and collectors have found new ways to tokenize and trade digital art, music, collectibles, virtual real estate, and more. The NFT market has witnessed tremendous growth, enabling creators to monetize their work like never before. As NFTs continue to gain popularity, they are reshaping how we perceive and exchange digital assets, presenting exciting opportunities and challenges in the realm of digital ownership.
                                </p>
                            </div>
                        </article>
                        <div className="mx-auto max-w-[48.125rem]">
                            ...
                            <div className="mb-16 flex items-center">
                                ...
                                <div className="flex space-x-2">
                                    <a href="#" className="group inline-flex h-10 w-10 items-center justify-center rounded-full border border-jacarta-100 bg-white transition-colors hover:border-transparent hover:bg-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:hover:bg-accent">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" className="h-4 w-4 fill-jacarta-400 transition-colors group-hover:fill-white dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                                        </svg>
                                    </a>
                                    <a href="#" className="group inline-flex h-10 w-10 items-center justify-center rounded-full border border-jacarta-100 bg-white transition-colors hover:border-transparent hover:bg-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:hover:bg-accent">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" className="h-4 w-4 fill-jacarta-400 transition-colors group-hover:fill-white dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z" />
                                        </svg>
                                    </a>
                                    <a href="#" className="group inline-flex h-10 w-10 items-center justify-center rounded-full border border-jacarta-100 bg-white transition-colors hover:border-transparent hover:bg-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:hover:bg-accent">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" className="h-4 w-4 fill-jacarta-400 transition-colors group-hover:fill-white dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                                        </svg>
                                    </a>
                                    <a href="mailto:test@gmail.com" className="group inline-flex h-10 w-10 items-center justify-center rounded-full border border-jacarta-100 bg-white transition-colors hover:border-transparent hover:bg-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:hover:bg-accent">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="email" className="h-4 w-4 fill-jacarta-400 transition-colors group-hover:fill-white dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            ...
                            <div className="mb-16 flex rounded-2.5xl border border-jacarta-100 bg-white p-8 dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/blog/author_large.jpg" alt="author" className="mr-4 h-16 w-16 shrink-0 self-start rounded-lg md:mr-8 md:h-[9rem] md:w-[9rem]" />
                                <div>
                                    ...
                                    <div className="flex space-x-5">
                                        <a href="#" className="group">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" className="h-4 w-4 fill-jacarta-400 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z" />
                                            </svg>
                                        </a>
                                        <a href="#" className="group">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" className="h-4 w-4 fill-jacarta-400 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <path d="M459.37 151.716c.325 4.548.325 9.097.325 13.645 0 138.72-105.583 298.558-298.558 298.558-59.452 0-114.68-17.219-161.137-47.106 8.447.974 16.568 1.299 25.34 1.299 49.055 0 94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319-28.264-18.843-46.781-51.005-46.781-87.391 0-19.492 5.197-37.36 14.294-52.954 51.655 63.675 129.3 105.258 216.365 109.807-1.624-7.797-2.599-15.918-2.599-24.04 0-57.828 46.782-104.934 104.934-104.934 30.213 0 57.502 12.67 76.67 33.137 23.715-4.548 46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z" />
                                            </svg>
                                        </a>
                                        <a href="#" className="group">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="discord" className="h-4 w-4 fill-jacarta-400 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                                                <path d="M524.531,69.836a1.5,1.5,0,0,0-.764-.7A485.065,485.065,0,0,0,404.081,32.03a1.816,1.816,0,0,0-1.923.91,337.461,337.461,0,0,0-14.9,30.6,447.848,447.848,0,0,0-134.426,0,309.541,309.541,0,0,0-15.135-30.6,1.89,1.89,0,0,0-1.924-.91A483.689,483.689,0,0,0,116.085,69.137a1.712,1.712,0,0,0-.788.676C39.068,183.651,18.186,294.69,28.43,404.354a2.016,2.016,0,0,0,.765,1.375A487.666,487.666,0,0,0,176.02,479.918a1.9,1.9,0,0,0,2.063-.676A348.2,348.2,0,0,0,208.12,430.4a1.86,1.86,0,0,0-1.019-2.588,321.173,321.173,0,0,1-45.868-21.853,1.885,1.885,0,0,1-.185-3.126c3.082-2.309,6.166-4.711,9.109-7.137a1.819,1.819,0,0,1,1.9-.256c96.229,43.917,200.41,43.917,295.5,0a1.812,1.812,0,0,1,1.924.233c2.944,2.426,6.027,4.851,9.132,7.16a1.884,1.884,0,0,1-.162,3.126,301.407,301.407,0,0,1-45.89,21.83,1.875,1.875,0,0,0-1,2.611,391.055,391.055,0,0,0,30.014,48.815,1.864,1.864,0,0,0,2.063.7A486.048,486.048,0,0,0,610.7,405.729a1.882,1.882,0,0,0,.765-1.352C623.729,277.594,590.933,167.465,524.531,69.836ZM222.491,337.58c-28.972,0-52.844-26.587-52.844-59.239S193.056,219.1,222.491,219.1c29.665,0,53.306,26.82,52.843,59.239C275.334,310.993,251.924,337.58,222.491,337.58Zm195.38,0c-28.971,0-52.843-26.587-52.843-59.239S388.437,219.1,417.871,219.1c29.667,0,53.307,26.82,52.844,59.239C470.715,310.993,447.538,337.58,417.871,337.58Z" />
                                            </svg>
                                        </a>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 gap-[1.875rem] sm:grid-cols-2">
                                ...
                                <article>
                                    <div className="overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg">
                                        <figure className="group overflow-hidden">
                                            <Link to="/single-post">
                                                <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_6.jpg" alt="post 6" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                            </Link>
                                        </figure>
                                        {/* Body */}
                                        <div className="rounded-b-[1.25rem] border border-t-0 border-jacarta-100 bg-white p-[10%] dark:border-jacarta-600 dark:bg-jacarta-700">
                                            ...
                                            <h2 className="mb-4 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent">
                                                <Link to="/single-post">Inflation is up, it matters: High prices plague Biden's</Link>
                                            </h2>
                                ...
                                <article>
                                    <div className="overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg">
                                        <figure className="group overflow-hidden">
                                            <Link to="/single-post">
                                                <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_7.jpg" alt="post 7" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                            </Link>
                                        </figure>
                                        {/* Body */}
                                        <div className="rounded-b-[1.25rem] border border-t-0 border-jacarta-100 bg-white p-[10%] dark:border-jacarta-600 dark:bg-jacarta-700">
                                            ...
                                            <h2 className="mb-4 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent">
                                                <Link to="/single-post">What to do when the market is going everywhere</Link>
                                            </h2>
                                            <p className="mb-8 dark:text-jacarta-200">
                                                Since we launched Tezos at the end of 2021, many awesome creators...
                                            </p>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body p-6">
                            ...
                            <div className="mt-4 flex items-center space-x-2">
                                ...
                                <label htmlFor="buyNowTerms" className="text-sm dark:text-jacarta-200">By checking this box, I agree to Xhibiter's <Link to="/terms" className="text-accent">Terms of Service</Link></label>
                            </div>
                        </div>
                        {/* end body */}
                        <div className="modal-footer">
