...
function Contact() {
  return (
    <div>
      ...
      <link rel="apple-touch-icon" sizes="114x114" href="https://deothemes.com/envato/xhibiter/html/img/apple-touch-icon-114x114.png" />
      {/* Header */}
      ...
      <main className="pt-[5.5rem] lg:pt-24">
        {/* Page Title */}
        <section className="relative bg-cover bg-center bg-no-repeat py-32 after:absolute after:inset-0 after:bg-jacarta-900/60" style={{ backgroundImage: 'url("https://deothemes.com/envato/xhibiter/html/img/page-title/knowledge_base_banner.jpg")' }}>
                ...
                <form id="contact-form" method="post">
                  <div className="flex space-x-7">
                    <div className="mb-6 w-1/2">
                      ...
                      <input name="name" className="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" id="name" type="text" required />
                    </div>
                    <div className="mb-6 w-1/2">
                  ...
                  <div className="mb-4">
                    ...
                    <textarea id="message" className="contact-form-input w-full rounded-lg border-jacarta-100 py-3 hover:ring-2 hover:ring-accent/10 focus:ring-accent dark:border-jacarta-600 dark:bg-jacarta-700 dark:text-white dark:placeholder:text-jacarta-300" required name="message" rows={5} defaultValue={""} />
                  </div>
                  <div className="mb-6 flex items-center space-x-2">
                    <input type="checkbox" id="contact-form-consent-input" name="agree-to-terms" className="h-5 w-5 self-start rounded border-jacarta-200 text-accent checked:bg-accent focus:ring-accent/20 focus:ring-offset-0 dark:border-jacarta-500 dark:bg-jacarta-600" />
                    <label htmlFor="contact-form-consent-input" className="text-sm dark:text-jacarta-200">I agree to the <Link to="/terms" className="text-accent">Terms of Service</Link></label>
                  </div>
                ...
                <div className="rounded-2.5xl border border-jacarta-100 bg-white p-10 dark:border-jacarta-600 dark:bg-jacarta-700">
                  <div className="mb-6 flex items-center space-x-5">
                    ...
                    <div>
                      ...
                      <a href="tel:+919650519521" className="text-sm hover:text-accent dark:text-jacarta-300">+91 9650519521</a>
                    </div>
                  </div>
                  <div className="mb-6 flex items-center space-x-5">
                    <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-jacarta-100 bg-light-base dark:border-jacarta-600 dark:bg-jacarta-700">
                    ...
                    <div>
                      ...
                      <address className="text-sm not-italic dark:text-jacarta-300">3 Near Rithala Metro Station Rohini Sector 5, Institutional Area, New Delhi, Delhi 110085</address>
                    </div>
                  </div>
                  <div className="flex items-center space-x-5">
                    ...
                    <div>
                      ...
                      <a href="mailto:office@TokenTrove.com" className="text-sm not-italic hover:text-accent dark:text-jacarta-300">office@TokenTrove.com</a>
                    </div>
                  </div>
                </div>
              </div>
