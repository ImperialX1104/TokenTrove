                ...
                <section className="relative py-16 md:py-24">
                    ...
                    <div className="container">
                        ...
                        <article className="mb-[1.875rem] md:mb-16">
                            <div className="flex flex-col overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg md:flex-row">
                                <figure className="group overflow-hidden md:w-1/2">
                                    <Link to="/single-post">
                                        <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_1.jpg" alt="post 1" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                        </Link>
                                </figure>
                                {/* Body */}
                        ...
                        <div className="grid grid-cols-1 gap-[1.875rem] sm:grid-cols-2 md:grid-cols-3">
                            ...
                            <article>
                                <div className="overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg">
                                    <figure className="group overflow-hidden">
                                        <Link to="/single-post">
                                            <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_5.jpg" alt="post 5" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                            </Link>
                                    </figure>
                                    {/* Body */}
                                    <div className="rounded-b-[1.25rem] border border-t-0 border-jacarta-100 bg-white p-[10%] dark:border-jacarta-600 dark:bg-jacarta-700">
                                        ...
                                        <h2 className="mb-4 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent">
                                            <Link to="/single-post">Incredible Amount of Developer Energy' in Web3</Link>
                                        </h2>
                                        <p className="mb-8 dark:text-jacarta-200">
                                            Since we launched Tezos at the end of 2021, many awesome creators...
                                        </p>
                        ...
                        <div className="mt-10 text-center">
                            <Link to="/blog" className="inline-block rounded-full bg-accent py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark">Load More</Link>
                        </div>
                    </div>
                </section>
                {/* end blog */}
