        ...
        <div className="flex items-center px-6 py-6 xl:px-24">
          ...
          <div className="ml-auto flex lg:hidden">
            ...
            <main className="pt-[5.5rem] lg:pt-24">
                {/* Wallet */}
                <section className="relative bg-cover bg-center bg-no-repeat py-24 after:absolute after:inset-0 after:bg-jacarta-900/60" style={{ backgroundImage: 'url("https://deothemes.com/envato/xhibiter/html/img/page-title/wallet_banner.jpg")' }}>
                    ...
                    <div className="container">
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-[1.875rem]">
                            <a href="#" className="mb-8 rounded-2.5xl border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/metamask.svg" className="mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700" alt="wallet" />
                            ...
                            <a href="#" className="mb-8 rounded-2.5xl border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/coinbase.svg" className="mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700" alt="wallet" />
                            ...
                            <a href="#" className="mb-8 rounded-2.5xl border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/bitski.svg" className="mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700" alt="wallet" />
                            ...
                            <a href="#" className="mb-8 rounded-2.5xl border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/fortmatic.svg" className="mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700" alt="wallet" />
                            ...
                            <a href="#" className="mb-8 rounded-2.5xl border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/torus.svg" className="mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700" alt="wallet" />
                            ...
                            <a href="#" className="mb-8 rounded-2.5xl border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/wallets/wallet_connect.svg" className="mx-auto mb-7 -mt-[3.5rem] h-[5.5rem] w-[5.5rem] rounded-full border border-jacarta-100 bg-white dark:border-jacarta-600 dark:bg-jacarta-700" alt="wallet" />
