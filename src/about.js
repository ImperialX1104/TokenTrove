        ...
        <div>
                    ...
                    <div className="js-mobile-menu invisible lg:visible fixed inset-0 z-10 ml-auto items-center bg-white opacity-0 dark:bg-jacarta-800 lg:relative lg:inset-auto lg:flex lg:bg-transparent lg:opacity-100 dark:lg:bg-transparent">
                        ...
                        <div className="ml-8 hidden lg:flex xl:ml-12">
                            ...
                            <a href="#" className="js-wallet group flex h-10 w-10 items-center justify-center rounded-full border border-jacarta-100 bg-white transition-colors hover:border-transparent hover:bg-accent focus:border-transparent focus:bg-accent dark:border-transparent dark:bg-white/[.15] dark:hover:bg-accent" data-bs-toggle="modal" data-bs-target="#walletModal" aria-label="wallet">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={0} height={0} className="h-4 w-4 fill-jacarta-700 transition-colors group-hover:fill-white group-focus:fill-white dark:fill-white">
                                    <path fill="none" d="M0 0h24v24H0z" />
                                ...
                                <div className="dropdown-menu group-dropdown-hover:visible lg:invisible !-right-4 !top-[85%] !left-auto z-10 hidden min-w-[14rem] whitespace-nowrap rounded-xl bg-white transition-all will-change-transform before:absolute before:-top-3 before:h-3 before:w-full group-dropdown-hover:opacity-100 dark:bg-jacarta-800 lg:absolute lg:grid lg:!translate-y-4 lg:py-4 lg:px-2 lg:opacity-0 lg:shadow-2xl" aria-labelledby="profileDropdown">
                                    ...
                                    <div className="mx-5 mb-6 rounded-lg border border-jacarta-100 p-4 dark:border-jacarta-600">
                                        ...
                                        <div className="flex items-center">
                                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x={20} y={20} viewBox="0 0 1920 1920" xmlSpace="preserve" className="-ml-1 mr-1 h-[1.125rem] w-[1.125rem]">
                ...
                <section className="relative pt-24 lg:pb-96">
                    ...
                    <div className="container">
                        ...
                        <div className="mx-auto max-w-2xl py-16 text-center">
                            <h1 className="mb-8 font-display text-4xl font-medium text-jacarta-700 dark:text-white">About TokenTrove</h1>
                ...
                <section className="pb-24">
                    <div className="container">
                        ...
                        <figure className="relative mt-16 overflow-hidden rounded-3xl before:absolute before:inset-0 before:bg-jacarta-900/25 lg:-mt-96">
                            <img src="https://deothemes.com/envato/xhibiter/html/img/about/video_cover.jpg" className="w-full" alt="video" />
                            <a href="https://www.youtube.com/embed/dQw4w9WgXcQ" data-bs-toggle="modal" data-bs-target=".video-lightbox" className="js-video-modal-trigger absolute top-1/2 left-1/2 flex h-24 w-24 -translate-y-1/2 -translate-x-1/2 items-center justify-center rounded-full border-2 border-white transition-transform will-change-transform hover:scale-90">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="h-rotate h-8 w-8 fill-white">
                                    <path fill="none" d="M0 0h24v24H0z" />
                        ...
                        {/* Statistics */}
                        <div className="pt-24">
                            <h2 className="mb-16 text-center font-display text-3xl text-jacarta-700 dark:text-white">Numbers Speak</h2>
                            <div className="grid grid-cols-2 md:grid-cols-4">
                                <div className="mb-10 text-center">
                                    <span className="block font-display text-5xl text-jacarta-700 dark:text-white">2019</span>
                                    <span className="block dark:text-jacarta-300">Founded</span>
                                </div>
                                <div className="mb-10 text-center">
                                    <span className="block font-display text-5xl text-jacarta-700 dark:text-white">$178M</span>
                                    <span className="block dark:text-jacarta-300">Trading volume</span>
                                </div>
                                <div className="mb-10 text-center">
                                    <span className="block font-display text-5xl text-jacarta-700 dark:text-white">305K</span>
                                    <span className="block dark:text-jacarta-300">NFTs created</span>
                                </div>
                                <div className="mb-10 text-center">
                                    <span className="block font-display text-5xl text-jacarta-700 dark:text-white">1.6M</span>
          ...
          " fill="#9446ED" />
                                        ...
                                        <g clipPath="url(#clipping)">
                                            {/* Bg image */}
                                            <image href="https://deothemes.com/envato/xhibiter/html/img/about/story.jpg" width={200} height={200} clipPath="url(#clipping)" />
                                        </g>
                                    </svg>
                                    <img src="https://deothemes.com/envato/xhibiter/html/img/hero/3D_elements.png" alt className="absolute top-0 animate-fly" />
                                </div>
                            </div>
                            {/* Info */}
                            <div className="py-20 lg:w-[45%] lg:pl-16">
                                ...
                                <div className="flex space-x-4 sm:space-x-10">
                                    <div className="flex space-x-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="h-8 w-8 shrink-0 fill-accent">
                                            <path fill="none" d="M0 0h24v24H0z" />
                                            <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-.997-4L6.76 11.757l1.414-1.414 2.829 2.829 5.656-5.657 1.415 1.414L11.003 16z" />
                                        </svg>
                                        <div>
                                            <span className="block font-display text-xl text-jacarta-700 dark:text-white">11,2k+</span>
                                            <span className="text-jacarta-700 dark:text-jacarta-300">Products launched</span>
                                        </div>
                                    </div>
                                    <div className="flex space-x-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="h-8 w-8 shrink-0 fill-accent">
                                        ...
                                        <div>
                                            <span className="block font-display text-xl text-jacarta-700 dark:text-white">99,7%</span>
                                            <span className="text-jacarta-700 dark:text-jacarta-300">Satisfaction Rate</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="py-24">
                    <div className="container">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-[1.875rem] lg:grid-cols-5">
                            ...
                            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/team/team_6.jpg" className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-2.5xl" alt="team" />
                                <h3 className="font-display text-md text-jacarta-700 dark:text-white">Nathaniel Ragpa</h3>
                                <span className="text-2xs font-medium tracking-tight text-jacarta-400">Front-end Developer</span>
                                <div className="mt-3 flex justify-center space-x-5">
                                    <a href="#" className="group">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" className="h-4 w-4 fill-jacarta-300 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                            ...
                            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/team/team_7.jpg" className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-2.5xl" alt="team" />
                                <h3 className="font-display text-md text-jacarta-700 dark:text-white">Linda Brown</h3>
                                <span className="text-2xs font-medium tracking-tight text-jacarta-400">Marketing Officer</span>
                                <div className="mt-3 flex justify-center space-x-5">
                                    <a href="#" className="group">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" className="h-4 w-4 fill-jacarta-300 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                            ...
                            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/team/team_8.jpg" className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-2.5xl" alt="team" />
                                <h3 className="font-display text-md text-jacarta-700 dark:text-white">Gavin Silberman</h3>
                                <span className="text-2xs font-medium tracking-tight text-jacarta-400">Designer &amp; Investor</span>
                                <div className="mt-3 flex justify-center space-x-5">
                                    <a href="#" className="group">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" className="h-4 w-4 fill-jacarta-300 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                            ...
                            <div className="rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <img src="https://deothemes.com/envato/xhibiter/html/img/team/team_9.jpg" className="mx-auto mb-6 h-[8.125rem] w-[8.125rem] rounded-2.5xl" alt="team" />
                                <h3 className="font-display text-md text-jacarta-700 dark:text-white">Masha Smith</h3>
                                <span className="text-2xs font-medium tracking-tight text-jacarta-400">VP Communications</span>
                                <div className="mt-3 flex justify-center space-x-5">
                                    <a href="#" className="group">
                                        <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" className="h-4 w-4 fill-jacarta-300 group-hover:fill-accent dark:group-hover:fill-white" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                            <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                            ...
                            <a href="careers.html" className="flex items-center justify-center rounded-2lg border border-jacarta-100 bg-white p-8 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                ...
                <div className="container">
                    <div className="grid grid-cols-2 py-8 sm:grid-cols-5">
                        <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_1.png" alt="partner 1" /></a>
                        <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_2.png" alt="partner 2" /></a>
                        <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_3.png" alt="partner 3" /></a>
                        <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_4.png" alt="partner 4" /></a>
                        <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_5.png" alt="partner 5" /></a>
                    </div>
                </div>
                {/* Latest Posts */}
                        ...
                        <div className="grid grid-cols-1 gap-[1.875rem] sm:grid-cols-2 md:grid-cols-3">
                            <article>
                                <div className="overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg">
                                    <figure className="group overflow-hidden">
                                        <Link to="/single-post">
                                            <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_2.jpg" alt="post 2" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                        </Link>
                                    </figure>
                                    {/* Body */}
                                    <div className="rounded-b-[1.25rem] border border-t-0 border-jacarta-100 bg-white p-[10%] dark:border-jacarta-600 dark:bg-jacarta-700">
                                        ...
                                        <h2 className="mb-4 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent">
                                            <Link to="/single-post"> Mint your own Tezos collections </Link>
                                        </h2>
                            ...
                            <article>
                                <div className="overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg">
                                    <figure className="group overflow-hidden">
                                        <Link to="/single-post">
                                            <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_3.jpg" alt="post 3" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                        </Link>``
                                    </figure>
                                    {/* Body */}
                                    <div className="rounded-b-[1.25rem] border border-t-0 border-jacarta-100 bg-white p-[10%] dark:border-jacarta-600 dark:bg-jacarta-700">
                                        ...
                                        <h2 className="mb-4 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent">
                                            <Link to="/single-post">List your collection for secondary sales</Link>
                                        </h2>
                                        <p className="mb-8 dark:text-jacarta-200">
                                            Since we launched Tezos at the end of 2021, many awesome creators...
                                        </p>
                            ...
                            <article>
                                <div className="overflow-hidden rounded-2.5xl transition-shadow hover:shadow-lg">
                                    <figure className="group overflow-hidden">
                                        <Link to="/single-post">
                                            <img src="https://deothemes.com/envato/xhibiter/html/img/blog/post_4.jpg" alt="post 4" className="h-full w-full object-cover transition-transform duration-[1600ms] will-change-transform group-hover:scale-105" />
                                        </Link>
                                    </figure>
                                    {/* Body */}
                                    <div className="rounded-b-[1.25rem] border border-t-0 border-jacarta-100 bg-white p-[10%] dark:border-jacarta-600 dark:bg-jacarta-700">
                                        ...
                                        <h2 className="mb-4 font-display text-xl text-jacarta-700 hover:text-accent dark:text-white dark:hover:text-accent">
                                            <Link to="/single-post">The biggest moves in NFTs, Bitcoin, crypto rules</Link>
                                        </h2>
                                        <p className="mb-8 dark:text-jacarta-200">
                                            Since we launched Tezos at the end of 2021, many awesome creators...
                                        </p>
            ...
            {/* YouTube Video Modal */}
            <div className="modal fade video-lightbox js-video-lightbox" tabIndex={-1} aria-label="Youtube Modal" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-body">
                            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="h-6 w-6 fill-jacarta-700">
                                    <path fill="none" d="M0 0h24v24H0z" />
                                    <path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636z" />
                                </svg>
                            </button>
                            <div className="ratio ratio-16x9 before:bg-jacarta-900">
                                <iframe className="embed-responsive-item" src allow="autoplay" />
                            </div>
                        </div>
                    </div>
                </div>
