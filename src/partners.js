                    ...
                    <div className="container">
                        <div className="mx-auto max-w-xl text-center">
                            <h1 className="mb-6 text-center font-display text-4xl font-medium text-jacarta-700 dark:text-white">
                                TokenTrove Affiliate Partnership
                            </h1>
                            <p className="mb-16 text-lg leading-normal dark:text-jacarta-200">
                                Interested in making money with TokenTrove? Earn A 20% Commission For Every Sale You Refer By Recommending
                    ...
                    <div className="container">
                        ...
                        <div className="grid gap-7 md:grid-cols-3">
                            <div className="mb-12 rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
                                ...
                                <h3 className="mb-4 font-display text-lg text-jacarta-700 dark:text-white">Generate Revenue</h3>
                                <p className="dark:text-jacarta-300">
                            ...
                            <div className="mb-12 rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
                                ...
                                <h3 className="mb-4 font-display text-lg text-jacarta-700 dark:text-white">Reach Millions</h3>
                                <p className="dark:text-jacarta-300">
                            ...
                            <div className="mb-12 rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
                                ...
                                <h3 className="mb-4 font-display text-lg text-jacarta-700 dark:text-white">Gas-free Marketplace</h3>
                                <p className="dark:text-jacarta-300">
                            ...
                            <div className="mb-12 rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
                                ...
                                <h3 className="mb-4 font-display text-lg text-jacarta-700 dark:text-white">Advertise TokenTrove</h3>
                                <p className="dark:text-jacarta-300">
                            ...
                            <div className="mb-12 rounded-2.5xl border border-jacarta-100 bg-white p-8 pt-0 text-center transition-shadow hover:shadow-xl dark:border-jacarta-600 dark:bg-jacarta-700">
                                ...
                                <h3 className="mb-4 font-display text-lg text-jacarta-700 dark:text-white">Earn 20% Commission Per Sale!</h3>
                                <p className="dark:text-jacarta-300">
                ...
                <section className="bg-accent py-28">
                    <div className="container">
                        <div className="mx-auto max-w-2xl text-center">
                            ...
                            <Link to="/contact" className="inline-block rounded-full bg-white py-3 px-8 text-center font-semibold text-accent transition-all hover:bg-accent-dark hover:text-white">Sign Up Now</Link>
                        </div>
                    </div>
                </section>
                {/* end cta */}
                ...
                <div className="bg-light-base dark:bg-jacarta-800">
                    <div className="container">
                        <div className="grid grid-cols-2 py-8 sm:grid-cols-5">
                            ...
                            <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_2.png" alt="partner 1" /> </a>
                            <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_3.png" alt="partner 1" /> </a>
                            <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_4.png" alt="partner 1" /> </a>
                            <a href="#"><img src="https://deothemes.com/envato/xhibiter/html/img/partners/partner_logo_5.png" alt="partner 1" /> </a>
                        </div>
                    </div>
                </div>
            </main>
