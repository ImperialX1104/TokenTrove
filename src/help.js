        ...
        <div className="flex items-center px-6 py-6 xl:px-24">
          ...
          <div className="ml-auto flex lg:hidden">
            ...
            <main className="pt-[5.5rem] lg:pt-24">
                {/* Page Title */}
                <section className="relative bg-cover bg-center bg-no-repeat py-20 after:absolute after:inset-0 after:bg-jacarta-900/60" style={{ backgroundImage: 'url("https://deothemes.com/envato/xhibiter/html/img/page-title/knowledge_base_banner.jpg")' }}>
                    <div className="container relative z-10">
                        <h1 className="mb-4 text-center font-display text-4xl font-medium text-white">How can I help you?</h1>
                        <form action="search" className="relative mx-auto block max-w-md">
                            <input type="search" className="w-full rounded-2xl border border-jacarta-100 py-[0.6875rem] px-4 pl-10 text-jacarta-700 placeholder-jacarta-500 focus:ring-accent" placeholder="Search" />
                            <span className="absolute left-0 top-0 flex h-full w-12 items-center justify-center rounded-2xl">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className="h-4 w-4 fill-jacarta-500">
                                    <path fill="none" d="M0 0h24v24H0z" />
                                    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0 1 11 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 0 1-1.969 5.617zm-2.006-.742A6.977 6.977 0 0 0 18 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 0 0 4.875-1.975l.15-.15z" />
                                </svg>
                            </span>
                ...
                <section className="relative py-24">
                    ...
                    <div className="container">
                        ...
                        <div className="mb-16 grid grid-cols-1 gap-7 sm:grid-cols-2 md:grid-cols-3">
                            <a href="#" className="rounded-2lg border border-jacarta-100 bg-white p-6 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                            ...
                            <a href="#" className="rounded-2lg border border-jacarta-100 bg-white p-6 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <h3 className="mb-2 font-display text-base font-semibold text-jacarta-700 dark:text-white">Creating</h3>
                                <p className="dark:text-jacarta-300">
                                    Learn how to create an account, set up your wallet, and what you can do.
                                </p>
                            </a>
                            <a href="#" className="rounded-2lg border border-jacarta-100 bg-white p-6 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <h3 className="mb-2 font-display text-base font-semibold text-jacarta-700 dark:text-white">User Safety</h3>
                                <p className="dark:text-jacarta-300">
                                    Learn how to create an account, set up your wallet, and what you can do.
                                </p>
                            </a>
                            <a href="#" className="rounded-2lg border border-jacarta-100 bg-white p-6 text-center transition-shadow hover:shadow-lg dark:border-jacarta-600 dark:bg-jacarta-700">
                                <h3 className="mb-2 font-display text-base font-semibold text-jacarta-700 dark:text-white">Partners</h3>
                                <p className="dark:text-jacarta-300">
                                    Learn how to create an account, set up your wallet, and what you can do.
                                </p>
                            </a>
                        ...
                        <p className="mx-auto mb-10 max-w-md text-center text-lg text-jacarta-300">
                            ...
                            <Link to="/collections" className="text-accent">Contact Support</Link>
                        </p>
                        <div className="accordion mx-auto max-w-[35rem]" id="accordionFAQ">
                            <div className="accordion-item mb-5 overflow-hidden rounded-lg border border-jacarta-100 dark:border-jacarta-600">
                                <h2 className="accordion-header" id="faq-heading-1">
                                    <button className="accordion-button collapsed relative flex w-full items-center justify-between bg-white px-4 py-3 text-left font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-1" aria-expanded="false" aria-controls="faq-1">
                                ...
                                <div id="faq-1" className="accordion-collapse collapse" aria-labelledby="faq-heading-1" data-bs-parent="#accordionFAQ">
                                    <div className="accordion-body border-t border-jacarta-100 bg-white p-4 dark:border-jacarta-600 dark:bg-jacarta-700">
                                        <p className="dark:text-jacarta-200">
                                            A: Follow these steps to create an NFT: <br />

                                            1. Choose a blockchain platform like Ethereum. <br />
                                            2. Set up a cryptocurrency wallet (e.g., MetaMask). <br />
                                            3. Get cryptocurrency (e.g., ETH) to cover transaction fees. <br />
                                            4. Decide on your digital content to tokenize. <br />
                                            5. Select an NFT platform (e.g., OpenSea). <br />
                                            6. Mint your NFT by uploading content and adding metadata. <br />
                                            7. Pay transaction fees and confirm the minting process. <br />
                                            8. Your NFT is now minted and assigned a unique ID. <br />
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="accordion-item mb-5 overflow-hidden rounded-lg border border-jacarta-100 dark:border-jacarta-600">
                                <h2 className="accordion-header" id="faq-heading-2">
                                    <button className="accordion-button collapsed relative flex w-full items-center justify-between bg-white px-4 py-3 text-left font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-2" aria-expanded="false" aria-controls="faq-2">
                                ...
                                <div id="faq-2" className="accordion-collapse collapse" aria-labelledby="faq-heading-2" data-bs-parent="#accordionFAQ">
                                    <div className="accordion-body border-t border-jacarta-100 bg-white p-4 dark:border-jacarta-600 dark:bg-jacarta-700">
                                        <p className="dark:text-jacarta-200">
                                            To ensure the safety and protection of your NFTs, follow these best practices:

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>1. Use Secure Wallets:</span> Store your NFTs in reputable and secure cryptocurrency wallets that support NFTs, such as MetaMask, Trust Wallet, or Coinbase Wallet. Make sure to enable strong security features like two-factor authentication (2FA) to prevent unauthorized access.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>2. Backup Your Wallet:</span> Regularly back up your wallet's private keys, recovery phrases, or keystore files in a safe and offline location. This ensures you can recover your NFTs if you lose access to your wallet.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>3. Beware of Phishing:</span> Be cautious of phishing scams and fraudulent websites. Always double-check URLs, especially before entering your wallet credentials or interacting with NFT marketplaces.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>4. Verify Contracts:</span> Before buying or selling NFTs, ensure that the smart contracts of the platforms you're using are verified and audited for security. Scammers may create fake contracts to trick users.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>5. Use Reputable Marketplaces:</span> Only transact on well-known and reputable NFT marketplaces. Research the marketplace's history, user reviews, and security measures before trading.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>6. Private Transactions:</span> Be cautious when sharing transaction details or wallet addresses publicly. This information can be used by malicious actors to target your wallet.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>7. Minting NFTs:</span> If you're minting your own NFTs, double-check the metadata and content before finalizing the minting process. Incorrect or misleading information could affect the value and authenticity of your NFT.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>8. Keep Software Updated:</span> Regularly update your wallet software, browser extensions, and operating system to the latest versions. Updates often include security enhancements.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>9. Avoid Public Wi-Fi:</span> When accessing your wallet or performing transactions, avoid using public Wi-Fi networks that may be less secure. Opt for a private and secure internet connection.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}>10. Educate Yourself:</span> Continuously educate yourself about the latest security threats and best practices in the NFT space. Staying informed will help you make more secure decisions.

                                             <br />  <br /> <span style={{ fontWeight: 'bold' }}></span>Remember, while these tips can enhance the security of your NFTs, no method is foolproof. Always exercise caution and use your best judgment when dealing with digital assets.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className="accordion-item mb-5 overflow-hidden rounded-lg border border-jacarta-100 dark:border-jacarta-600">
                                <h2 className="accordion-header" id="faq-heading-3">
                                    <button className="accordion-button collapsed relative flex w-full items-center justify-between bg-white px-4 py-3 text-left font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-3" aria-expanded="false" aria-controls="faq-3">
                            ...
                            <div className="accordion-item mb-5 overflow-hidden rounded-lg border border-jacarta-100 dark:border-jacarta-600">
                                <h2 className="accordion-header" id="faq-heading-4">
                                    <button className="accordion-button collapsed relative flex w-full items-center justify-between bg-white px-4 py-3 text-left font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-4" aria-expanded="false" aria-controls="faq-4">
                            ...
                            <div className="accordion-item mb-5 overflow-hidden rounded-lg border border-jacarta-100 dark:border-jacarta-600">
                                <h2 className="accordion-header" id="faq-heading-5">
                                    <button className="accordion-button collapsed relative flex w-full items-center justify-between bg-white px-4 py-3 text-left font-display text-jacarta-700 dark:bg-jacarta-700 dark:text-white" type="button" data-bs-toggle="collapse" data-bs-target="#faq-5" aria-expanded="false" aria-controls="faq-5">
